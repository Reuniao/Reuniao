...
RSpec.describe PessoasController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all pessoas as @pessoas" do
      ...
      expect(assigns(:pessoas)).to eq([pessoa])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created pessoa as @pessoa" do
        ...
        expect(assigns(:pessoa)).to be_persisted
      end

      it "redirects to the created pessoa" do
        post :create, {:pessoa => valid_attributes}, valid_session
        expect(response).to redirect_to(Pessoa.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved pessoa as @pessoa" do
        post :create, {:pessoa => invalid_attributes}, valid_session
        expect(assigns(:pessoa)).to be_a_new(Pessoa)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "redirects to the pessoa" do
        pessoa = Pessoa.create! valid_attributes
        put :update, {:id => pessoa.to_param, :pessoa => valid_attributes}, valid_session
        expect(response).to redirect_to(pessoa)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the pessoa as @pessoa" do
        pessoa = Pessoa.create! valid_attributes
        put :update, {:id => pessoa.to_param, :pessoa => invalid_attributes}, valid_session
        expect(assigns(:pessoa)).to eq(pessoa)
      end
